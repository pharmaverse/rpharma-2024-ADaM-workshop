...
> > -   `Ben Straub` - presenting on ADSL
> > -   `Edoardo Mancini` - Chat Support
> > -   `Sadchla Mascary` - Chat Support

## Setting up Posit Environment

-   Sign up for a free [Posit Account](https://posit.cloud/)

-   Preferred - Share Link for R/Pharma: ADaM Workshop

    -   Everything loaded and ready to go!

-   Advanced Clone Repo and set up yourself

## How we will "code" today

-   Fanny and I will walk you through coding
    -   Fill in the blank!
-   For Questions please post into the Chat for Edoardo - (Edoardo can
    come off mute to address)
...
-   Using Specs to create numeric variables and order and finalize
    dataset
-   Write out final datasets as xpts (lengths, types, labels) using
    specs using `xportr`
-   ???
