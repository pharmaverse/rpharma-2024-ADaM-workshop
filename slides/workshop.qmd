...
## Setting up your Workspace {.smaller}
...
[Reference](https://pharmaverse.github.io/admiral/reference/) page:
which `admiral` function could be used to compute the Analysis Sequence Number
(Numbering the Observations Within Each Group)?
...
> -   pgkdown sites for [xportr](https://atorus-research.github.io/xportr/), [metatools](https://pharmaverse.github.io/metatools/), [metacore](https://atorus-research.github.io/metacore/) and [admiral](https://pharmaverse.github.io/admiral/)
> -   Extension packages for admiral: [admiralophtha](https://pharmaverse.github.io/admiralophtha/), [admiralonco](https://pharmaverse.github.io/admiralonco/), [admiralpeds](https://github.com/pharmaverse/admiralpeds)

## Closing Thoughts 

> -   We were only able to show a small number of `pharmaverse` packages and functions
